...
export class TokenStoreService {
  ...
  getDecodedAccessToken(): any {
    return jwtDecode<JwtPayload>(this.getRawAuthToken(AuthTokenType.AccessToken));
  }
  ...
  getCurrentUserId(): number {
    return +this.getDecodedAccessToken()['http://schemas.microsoft.com/ws/2008/06/identity/claims/userdata'];
  }
