...
namespace Saml
{
	...
	public partial class Response
	{
		...
		public Response(X509Certificate2 certificate, string responseString) 
		{
		...
		private bool IsExpired()
		{
			...
			XmlNode node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion[1]/saml:Subject/saml:SubjectConfirmation/saml:SubjectConfirmationData/saml:Conditions", _xmlNameSpaceManager);
		...
		{
			//XmlNode node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion[1]/saml:AttributeStatement/saml:Attribute[@Name='emailAddress']/saml:AttributeValue", _xmlNameSpaceManager);
			XmlNode node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion[1]/saml:Subject/saml:NameID", _xmlNameSpaceManager);
