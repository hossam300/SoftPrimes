...
namespace IHelperServices
{
    public interface ISignalRServices : _IHelperService
    {
        ...
        void UserRoleUpdated(IEnumerable<string> userName, List<int> RoleIds);
        void UserRoleUpdatedByValue(IEnumerable<string> userName, int UserRoleId);
        void RefreshAfterDelegation(string TransactionActionReceipientEncryptId, int? OrganizationId, int? UserId);
        void UpdateNotifications(List<int?> OrganizationIds);
